...
void GUI_Setup(UG_DEVICE *device)
{
    ...
    writeSerialPort(boutRefNum, "call fillscreen");
    // UG_FillScreen(C_BLACK);
    writeSerialPort(boutRefNum, "done call fillscreen");
...
void GUI_Process()
{
    writeSerialPort(boutRefNum, "call UG_Update");
    UG_Update();
    writeSerialPort(boutRefNum, "done call UG_Update");
}
